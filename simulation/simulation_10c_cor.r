## This is a simulation example for the correlated case of scenario 2.
## Under scenario 2 where OTUs are divided into 10 clusters, and the outcome is truly associated with the 1st cluster.
...
clu <- 10     ## OTUs are divided into 10 clusters under scenario 2
